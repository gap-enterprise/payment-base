...
public class PayBankNoteBook extends TableImpl<PayBankNoteBookRecord> {
    ...
    public List<ForeignKey<PayBankNoteBookRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<PayBankNoteBookRecord, ?>>asList(Keys.PAY_BANK_NOTE_BOOK__PAY_BANK_NOTE_BOOK_ACCOUNT_ID_FKEY);
    }
    ...
    public PayBankAccount payBankAccount() {
        if (_payBankAccount == null)
            _payBankAccount = new PayBankAccount(this, Keys.PAY_BANK_NOTE_BOOK__PAY_BANK_NOTE_BOOK_ACCOUNT_ID_FKEY);
