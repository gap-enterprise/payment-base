...
import io.surati.gap.payment.base.db.jooq.generated.tables.records.PayBankAccountViewRecord;
...
public class PayBankAccountView extends TableImpl<PayBankAccountViewRecord> {
     ...
     */
    public final TableField<PayBankAccountViewRecord, String> FULL_NUMBER = createField(DSL.name("full_number"), SQLDataType.CLOB, this, "");
