...
public class PayThirdParty extends TableImpl<PayThirdPartyRecord> {
    ...
    public List<UniqueKey<PayThirdPartyRecord>> getKeys() {
        return Arrays.<UniqueKey<PayThirdPartyRecord>>asList(Keys.PAY_THIRD_PARTY_PKEY);
    }

    @Override
    public List<ForeignKey<PayThirdPartyRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<PayThirdPartyRecord, ?>>asList(Keys.PAY_THIRD_PARTY__PAY_THIRD_PARTY_FAMILY_ID_FKEY);
    }
    ...
    public PayThirdPartyFamily payThirdPartyFamily() {
        if (_payThirdPartyFamily == null)
            _payThirdPartyFamily = new PayThirdPartyFamily(this, Keys.PAY_THIRD_PARTY__PAY_THIRD_PARTY_FAMILY_ID_FKEY);
