...
public class PayThirdPartyPaymentMeanAllowed extends TableImpl<PayThirdPartyPaymentMeanAllowedRecord> {
    ...
    public List<ForeignKey<PayThirdPartyPaymentMeanAllowedRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<PayThirdPartyPaymentMeanAllowedRecord, ?>>asList(Keys.PAY_THIRD_PARTY_PAYMENT_MEAN_ALLOWED__PAY_THIRD_PARTY_PAYMENT_MEAN_ALLOWED_THIRD_PARTY_ID_FKEY);
    }
    ...
    public PayThirdParty payThirdParty() {
        if (_payThirdParty == null)
            _payThirdParty = new PayThirdParty(this, Keys.PAY_THIRD_PARTY_PAYMENT_MEAN_ALLOWED__PAY_THIRD_PARTY_PAYMENT_MEAN_ALLOWED_THIRD_PARTY_ID_FKEY);
