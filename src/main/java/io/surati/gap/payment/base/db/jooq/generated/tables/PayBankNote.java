...
public class PayBankNote extends TableImpl<PayBankNoteRecord> {
    ...
    public List<ForeignKey<PayBankNoteRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<PayBankNoteRecord, ?>>asList(Keys.PAY_BANK_NOTE__PAY_BANK_NOTE_BOOK_ID_FKEY);
    }
    ...
    public PayBankNoteBook payBankNoteBook() {
        if (_payBankNoteBook == null)
            _payBankNoteBook = new PayBankNoteBook(this, Keys.PAY_BANK_NOTE__PAY_BANK_NOTE_BOOK_ID_FKEY);
