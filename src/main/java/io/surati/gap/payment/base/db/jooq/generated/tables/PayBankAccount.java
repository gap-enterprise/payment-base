...
public class PayBankAccount extends TableImpl<PayBankAccountRecord> {
    ...
    public List<ForeignKey<PayBankAccountRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<PayBankAccountRecord, ?>>asList(Keys.PAY_BANK_ACCOUNT__PAY_BANK_ACCOUNT_BANK_ID_FKEY, Keys.PAY_BANK_ACCOUNT__PAY_BANK_ACCOUNT_HOLDER_ID_FKEY);
    }
    ...
    public PayBank payBank() {
        if (_payBank == null)
            _payBank = new PayBank(this, Keys.PAY_BANK_ACCOUNT__PAY_BANK_ACCOUNT_BANK_ID_FKEY);
    ...
    public PayThirdParty payThirdParty() {
        if (_payThirdParty == null)
            _payThirdParty = new PayThirdParty(this, Keys.PAY_BANK_ACCOUNT__PAY_BANK_ACCOUNT_HOLDER_ID_FKEY);
