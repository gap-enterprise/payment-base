...
public class PayBankAccountAccountingSetting extends TableImpl<PayBankAccountAccountingSettingRecord> {
    ...
    public List<ForeignKey<PayBankAccountAccountingSettingRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<PayBankAccountAccountingSettingRecord, ?>>asList(Keys.PAY_BANK_ACCOUNT_ACCOUNTING_SETTING__PAY_BANK_ACCOUNT_ACCOUNTING_SETTING_ACCOUNT_ID_FKEY);
    }
    ...
    public PayBankAccount payBankAccount() {
        if (_payBankAccount == null)
            _payBankAccount = new PayBankAccount(this, Keys.PAY_BANK_ACCOUNT_ACCOUNTING_SETTING__PAY_BANK_ACCOUNT_ACCOUNTING_SETTING_ACCOUNT_ID_FKEY);
