...
import io.surati.gap.payment.base.jooq.generated.tables.records.PayReferenceDocumentViewRecord;
...
public class PayReferenceDocumentView extends TableImpl<PayReferenceDocumentViewRecord> {
    ...
    private PayReferenceDocumentView(Name alias, Table<PayReferenceDocumentViewRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("CREATE FORCE VIEW \"public\".\"pay_reference_document_view\"(\"id\", \"type_id\", \"date\", \"reference\", \"object\", \"place\", \"amount\", \"deposit_date\", \"entry_date\", \"issuer_id\", \"other_reference\", \"status_id\", \"step_id\", \"amount_paid\", \"amount_left\", \"name_issuer\", \"abbreviated_issuer\", \"code_issuer\") AS\nSELECT\n    \"rd\".\"id\",\n    \"rd\".\"type_id\",\n    \"rd\".\"date\",\n    \"rd\".\"reference\",\n    \"rd\".\"object\",\n    \"rd\".\"place\",\n    \"rd\".\"amount\",\n    \"rd\".\"deposit_date\",\n    \"rd\".\"entry_date\",\n    \"rd\".\"issuer_id\",\n    \"rd\".\"other_reference\",\n    \"rd\".\"status_id\",\n    \"rd\".\"step_id\",\n    \"rd\".\"amount_paid\",\n    \"rd\".\"amount_left\",\n    \"ps\".\"name\" AS \"name_issuer\",\n    \"tp\".\"abbreviated\" AS \"abbreviated_issuer\",\n    \"tp\".\"code\" AS \"code_issuer\"\nFROM \"public\".\"pay_reference_document\" \"rd\"\nLEFT OUTER JOIN \"public\".\"pay_third_party\" \"tp\"\n    ON \"tp\".\"id\" = \"rd\".\"issuer_id\"\nLEFT OUTER JOIN \"public\".\"ad_person\" \"ps\"\n    ON \"ps\".\"id\" = \"rd\".\"issuer_id\""));
    }
