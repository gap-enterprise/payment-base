...
public class PayPaymentMeanField extends TableImpl<PayPaymentMeanFieldRecord> {
    ...
    public List<ForeignKey<PayPaymentMeanFieldRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<PayPaymentMeanFieldRecord, ?>>asList(Keys.PAY_PAYMENT_MEAN_FIELD__PAY_PAYMENT_MEAN_FIELD_MEAN_ID_FKEY);
    }
    ...
    public PayPaymentMean payPaymentMean() {
        if (_payPaymentMean == null)
            _payPaymentMean = new PayPaymentMean(this, Keys.PAY_PAYMENT_MEAN_FIELD__PAY_PAYMENT_MEAN_FIELD_MEAN_ID_FKEY);
