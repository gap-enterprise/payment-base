...
public class PayPaymentOrder extends TableImpl<PayPaymentOrderRecord> {
    ...
    public List<ForeignKey<PayPaymentOrderRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<PayPaymentOrderRecord, ?>>asList(Keys.PAY_PAYMENT_ORDER_BENEFICIARY_ID_FKEY, Keys.PAY_PAYMENT_ORDER_REFERENCE_DOCUMENT_ID_FKEY, Keys.PAY_PAYMENT_ORDER_GROUP_ID_FKEY);
    }
    ...
    public PayThirdParty payThirdParty() {
        if (_payThirdParty == null)
            _payThirdParty = new PayThirdParty(this, Keys.PAY_PAYMENT_ORDER_BENEFICIARY_ID_FKEY);
    ...
    public PayReferenceDocument payReferenceDocument() {
        if (_payReferenceDocument == null)
            _payReferenceDocument = new PayReferenceDocument(this, Keys.PAY_PAYMENT_ORDER_REFERENCE_DOCUMENT_ID_FKEY);
    ...
    public PayPaymentOrderGroup payPaymentOrderGroup() {
        if (_payPaymentOrderGroup == null)
            _payPaymentOrderGroup = new PayPaymentOrderGroup(this, Keys.PAY_PAYMENT_ORDER_GROUP_ID_FKEY);
