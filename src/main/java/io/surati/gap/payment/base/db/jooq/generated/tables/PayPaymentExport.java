...
public class PayPaymentExport extends TableImpl<PayPaymentExportRecord> {
    ...
    public List<ForeignKey<PayPaymentExportRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<PayPaymentExportRecord, ?>>asList(Keys.PAY_PAYMENT_EXPORT__PAY_PAYMENT_EXPORT_PAYMENT_ID_FKEY);
    }
    ...
    public PayPayment payPayment() {
        if (_payPayment == null)
            _payPayment = new PayPayment(this, Keys.PAY_PAYMENT_EXPORT__PAY_PAYMENT_EXPORT_PAYMENT_ID_FKEY);
